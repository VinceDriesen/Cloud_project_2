...
@section('content')
    ...
    <div id="home" class="flex flex-col items-center min-h-[83.9vh]">
        <h1 class="text-primary-text-color text-4xl text-center mt-10 font-bold invisible">
            HealthSphere is the easiest way to manage everything about your health and hospitals <br />
        </h1>
        <h2 class="text-secondary-text-color text-2xl text-center my-5 invisible">
        ...
        <a
            href="/register"
            class="py-3 px-6 rounded-3xl bg-action hover:bg-action-hover text-primary-text-color mt-10 invisible"
