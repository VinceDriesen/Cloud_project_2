...
<div class="w-fit mx-auto mt-20 min-h-[83.9vh]">
    ...
    <form class="w-fit flex flex-col gap-5 border-2 border-component-border p-5 bg-foreground rounded-2xl"
          method="POST"
          action="/doctor/calendar/newAppointment">
        @csrf
        ...
        <header class="flex flex-row gap-20">
            <h1 class="text-primary-text-color p-1 outline-none bg-component w-full rounded-lg text-xl">
        ...
        <div class="flex flex-row gap-2 items-center">
            <input type="datetime-local" name="startDateTime" required
                   ...
                   value="{{ old('startDateTime', $event->begintimestamp ?? '') }}" />

            <span class="text-secondary-text-color text-lg">Duration (min):</span>
